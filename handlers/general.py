...
async def help_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "/myplans — See all your upcoming plans\n"
        "/weekend — Full weekend summary\n"
        "/status — See who's shared weekend plans\n\n"
        "*🎉 Events*\n"
        "/event — Create an event with attendance poll\n"
        "/seeevents — See all upcoming events\n"
        "/close\\_poll \\[id\\] — Close an event poll\n"
        "/reminders \\[id\\] — Change reminder settings\n"
        "/mute \\[id\\] — Mute reminders for yourself\n\n"
        "*🏠 Spaces & Assets*\n"
        "/book — Book a shared space/asset\n"
        "/spaces — See all upcoming bookings\n"
        "/cancel\\_booking \\[id\\] — Cancel your booking\n\n"
        "*✈️ Travel*\n"
        "/travel — Add a trip to the family calendar\n"
        "/trips — See all upcoming family trips\n"
